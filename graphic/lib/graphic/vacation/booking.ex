defmodule Graphic.Vacation.Booking do
  use Ecto.Schema
  ...
  defp dates_available?(start_date, end_date, place_id) do
    query =
      from booking in Graphic.Vacation.Booking,
        where:
    ...
    case Graphic.Repo.all(query) do
      [] -> true
      _ -> false
    end
  end
  ...
  defp calculate_total_price(changeset) do
    case changeset.valid? do
      true ->
        ...
        place = Graphic.Repo.get!(Graphic.Vacation.Place, place_id)
