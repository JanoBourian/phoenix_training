defmodule Vemosla.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Vemosla.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Vemosla.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Vemosla.ShoppingCart.create_cart_item()
